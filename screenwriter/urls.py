...
urlpatterns = patterns('bigpeople.screenwriter.views',
    ...
    url(r'^(?P<slug>[-\w]+)/scene/$', 'scene_list', {'template': 'scriptlist'}, name='scene_list_noform'),
    url(r'^(?P<slug>[-\w]+)/scene/add/$', 'scene_list', {'template': 'scriptlist', 'form':True}, name='scene_list_form'),
